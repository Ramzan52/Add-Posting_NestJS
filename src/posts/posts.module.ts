...
import { FavoritePosts, FavoritePostsSchema } from './schemas/favorite-posts.schema';

@Module({
  imports: [
    MongooseModule.forFeature([{ name: Post.name, schema: PostSchema }]),
    MongooseModule.forFeature([{ name: FavoritePosts.name, schema: FavoritePostsSchema }]),
  ],
